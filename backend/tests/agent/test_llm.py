...
def test_get_llm_deepseek_dispatches_correctly() -> None:
    with patch("app.core.llm_factory.ChatDeepSeek") as mock:
...
def test_get_llm_openai_dispatches_correctly() -> None:
    with patch("app.core.llm_factory.ChatOpenAI") as mock:
...
def test_get_llm_anthropic_dispatches_correctly() -> None:
    with patch("app.core.llm_factory.ChatAnthropic") as mock:
...
def test_get_llm_zhipuai_dispatches_correctly() -> None:
    with patch("app.core.llm_factory.ChatZhipuAI") as mock:
