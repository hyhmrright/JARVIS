...
async def test_get_ollama_models_success():
    ...
    mock_response = {
        "models": [
            {"name": "llama3:latest", "model": "llama3:latest", "modified_at": "2024-03-10T14:30:00Z", "size": 4661224679, "digest": "sha256:123"},
            {"name": "mistral:latest", "model": "mistral:latest", "modified_at": "2024-03-10T14:30:00Z", "size": 4109865159, "digest": "sha256:456"}
        ]
    }
